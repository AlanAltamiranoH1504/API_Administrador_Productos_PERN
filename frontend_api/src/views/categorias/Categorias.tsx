    ...
    if (data) return (
        <>
            <div className="flex justify-between">
                <h2 className="text-4xl font-black text-slate-700">Categorias</h2>
                ...
                <table className="w-full mt-5 table-auto">
                    ...
                    {data.map((categoria) => (
                        <tr key={categoria.id} className="border-b text-center">
                            ...
                            <td className="p-3 text-lg text-gray-800 font-semibold">
                                {formatoFecha(categoria.createdAt)}
                            </td>
                            <td className="p-3 text-lg text-gray-800 font-semibold">
                                {formatoFecha(categoria.updatedAt)}
                            </td>
